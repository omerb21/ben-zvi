...
from app.services import justification_forms_overlay_impl as _impl
...
def _get_default_signature_image_path() -> Optional[Path]:
    return _impl._get_default_signature_image_path()
...
def _register_overlay_font() -> str:
    ...
    font_name = _impl._register_overlay_font()
    _OVERLAY_FONT_NAME = _impl._OVERLAY_FONT_NAME
    return font_name


def _parse_rel_signature_position(signature_position: Optional[str]) -> tuple[Optional[float], Optional[float]]:
    return _impl._parse_rel_signature_position(signature_position)
...
def _draw_signature_image(
    ...
    return _impl._draw_signature_image(
        c,
        img_obj,
        signature_position,
        page_width,
...
def _try_draw_signature_image_from_data_url(
    ...
    *,
    ...
    return _impl._try_draw_signature_image_from_data_url(
        c,
...
def _try_draw_signature_image_from_static_file(
    ...
    *,
    ...
    return _impl._try_draw_signature_image_from_static_file(
        c,
        signature_position=signature_position,
        page_width=page_width,
        page_height=page_height,
...
def _get_overlay_target_page(reader, signature_position: Optional[str]):
    return _impl._get_overlay_target_page(reader, signature_position)
...
def _draw_free_text_block(
    ...
    *,
    ...
    return _impl._draw_free_text_block(
        c,
        free_text,
        page_height=page_height,
...
def apply_overlay_to_pdf(
    ...
    """
    global _OVERLAY_FONT_NAME
    result = _impl.apply_overlay_to_pdf(
        source_pdf_bytes,
        free_text=free_text,
        signature_image_data=signature_image_data,
        signature_position=signature_position,
